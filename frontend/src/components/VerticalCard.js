         ...
         loading ? (
             ...
             data.map((product,index)=>{
                ...
                {product?.price}
                             ...
                             <button className='text-sm bg-blue-600 hover:bg-blue-700 text-white px-3 py-0.5 rounded-full' onClick={(e)=>handleAddToCart(e,product?._id)}>افزودن به سبد خرید</button>
                         </div>
                     </Link>
                 )
             })
